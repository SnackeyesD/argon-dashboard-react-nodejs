...
import routeProd from './routeskbn/infoprod.js'
import routAddProd from './routeskbn/ajoutprod.js'
import routImages from './routeskbn/imagesupload.js'
...
app.use('/api/addprod', routAddProd)
app.use('/api/images', routImages)
app.use('/sauvegarde', express.static('./public/images/productsimage'));
